...
// Shared fetch for whichever ids are queued for comparison (10_Phase_3.md
// P3-T42) — used by both CompareDrawer (thumbnails) and the /compare page
// (full spec table) so there's exactly one fetch path, mirroring
...
export function compareQueryKey(ids: string[]) {

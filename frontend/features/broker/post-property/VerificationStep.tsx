...
export function VerificationStep({ onBack, onSubmit, isSubmitting, onStepSelect }: VerificationStepProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-8">
      ...
      <PostPropertyStepper current="verification" onStepSelect={onStepSelect} />
      <FreePlanUsageBar />

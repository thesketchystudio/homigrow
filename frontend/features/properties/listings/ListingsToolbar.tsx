...
export function ListingsToolbar({ total, city, sort, onSortChange, onOpenFilters }: ListingsToolbarProps) {
  return (
    <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
      <div className="flex flex-col gap-1">
        <h1 className="font-heading text-[28px] font-bold text-brand-primary-400">{city ? `Properties in ${city}` : "Curated Listings"}</h1>

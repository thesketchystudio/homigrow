...
Portal-specific ongoing status lives in `backend/CLAUDE.md` and
`frontend/CLAUDE.md` — each loads automatically only when working in
that directory, keeping this root file lean. What follows here is the
